...
public class PolyPolyline extends AbstractPolyPolyline {
    ...
    public PolyPolyline() {
        super(7, 1, (Rectangle) null, (int[]) null, (Point[][]) null);
    }

    public PolyPolyline(Rectangle rectangle, int i, int i2, int[] iArr, Point[][] pointArr) {
        super(7, 1, rectangle, iArr, pointArr);
        this.start = i;
        this.end = Math.min(i2, iArr.length - 1);
    }
