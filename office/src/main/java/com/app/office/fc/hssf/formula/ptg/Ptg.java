...
public abstract class Ptg {
                ...
                switch (b2) {
                    ...
                    default:
                        switch (b2) {
                            ...
                            default:
                                throw new UnsupportedOperationException(" Unknown Ptg in Formula: 0x" + Integer.toHexString(b) + " (" + b + ")");
                        }
                }
        }
    }
    ...
    private static Ptg createBasePtg(byte b, LittleEndianInput littleEndianInput) {
        switch (b) {
            ...
            default:
                throw new RuntimeException("Unexpected base token id (" + b + ")");
        }
    }
    ...
    public static boolean doesFormulaReferToDeletedCell(Ptg[] ptgArr) {
        for (Ptg isDeletedCellRef : ptgArr) {
