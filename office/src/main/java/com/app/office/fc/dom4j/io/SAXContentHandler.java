...
import com.app.office.fc.dom4j.dtd.AttributeDecl;
import com.app.office.fc.dom4j.dtd.ElementDecl;
import com.app.office.fc.dom4j.dtd.ExternalEntityDecl;
import com.app.office.fc.dom4j.dtd.InternalEntityDecl;
import com.app.office.fc.dom4j.tree.AbstractElement;
...
public class SAXContentHandler extends DefaultHandler implements LexicalHandler, DeclHandler, DTDHandler {
    ...
    public void addAttributes(Element element, Attributes attributes) {
        ...
        for (int i = 0; i < length; i++) {
            ...
            if (!qName.startsWith(SecurityConstants.XMLNS)) {
