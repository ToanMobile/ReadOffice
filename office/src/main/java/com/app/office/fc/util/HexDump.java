...
public class HexDump {
    ...
    public static String toHex(byte[] bArr, int i) {
        int round = (int) Math.round((Math.log((double) bArr.length) / Math.log(10.0d)) + 0.5d);
        StringBuffer stringBuffer = new StringBuffer();
        ...
        stringBuffer2.append(decimalFormat.format(0));
        int i3 = -1;
        for (int i4 = 0; i4 < bArr.length; i4++) {
            i3++;
            if (i3 == i) {
                stringBuffer2.append(10);
                stringBuffer2.append(decimalFormat.format((long) i4));
                i3 = 0;
            }
    ...
    public static String toHex(short s) {
        return toHex((long) s, 4);
    }

    public static String toHex(byte b) {
        return toHex((long) b, 2);
    }

    public static String toHex(int i) {
        return toHex((long) i, 8);
    }
    ...
    public static void dump(InputStream inputStream, PrintStream printStream, int i, int i2) throws IOException {
        ...
        dump(byteArray, 0, printStream, i, byteArray.length);
    }
    ...
    public static char[] intToHex(int i) {
        return toHexChars((long) i, 4);
    }

    public static char[] shortToHex(int i) {
        return toHexChars((long) i, 2);
    }

    public static char[] byteToHex(int i) {
        return toHexChars((long) i, 1);
    }
    ...
    public static void main(String[] strArr) throws Exception {
        ...
        System.out.println(dump(bArr, 0, 0));
